  ...
  return (
    <BasicLayout title="Home Page">
      <div className="HomePage">
        ...
        <p>
          Ipsa optio illo quos nemo doloremque debitis! Nemo architecto minima,
          dolor earum maiores cupiditate atque vitae ad rem nesciunt sapiente
          eveniet sequi eius dolorum doloribus? Facere illo corrupti earum
          libero?
        </p>
        <p>
        ...
        <p>
          ...
          fuga, necessitatibus ipsum pariatur omnis nemo laborum vel, odit qui,
          aspernatur cupiditate magni ut vero placeat libero nam voluptates?
          Illo, iste!
        </p>
        <p>
          Fugit, magnam culpa a deleniti quod quibusdam cumque provident illum
          ab repellat nisi doloremque dolore sit illo laudantium! Eligendi autem
          quos impedit at! Ad, incidunt? Nam doloribus modi magni quaerat.
        </p>
        <p>
          Culpa expedita autem, dignissimos nemo error ullam hic, fuga tempore
          unde quas voluptates illo cupiditate distinctio quo atque. Distinctio
          sed aliquam autem dolore mollitia? Odit vitae aperiam obcaecati
          mollitia eos!
        </p>
        <p>
          Enim facere consequatur quas est. Exercitationem maiores voluptates
          tempore cupiditate explicabo labore ut odio veritatis quibusdam nisi,
          quo, cumque quia! Excepturi dolorem saepe molestias cumque mollitia
          minus voluptas odit voluptate.
        </p>
        <p>
          Quos necessitatibus saepe consequuntur, soluta repellendus praesentium
          dolore modi quia ea aperiam, impedit vel consequatur ipsa odit
          adipisci nemo cupiditate deleniti asperiores corporis voluptatibus.
          Cupiditate vitae voluptate fugit recusandae dicta.
        </p>
        <p>
